...
%   are verified by runAnalysis.m and will show NOT COVERED in the coverage report.
    ...
    tcs = {
      ...
      'TC-GS-002','Throughput test', ...
        'Run kitchen at full demand for 1 hour with representative recipe mix. Measure bowls completed. Pass: >= 200 bowls.', ...
        'SR-GS-002';
      'TC-GS-003','Automation level audit', ...
        'Record time spent in manual mode per component over a 24 h representative shift. Compute automationLevel per component. Pass: mean >= 0.80.', ...
        'SR-GS-003';
      'TC-GS-004','Concurrent operator count', ...
        'Observe crew present on the kitchen floor at peak demand. Pass: <= 5 simultaneous operators required.', ...
        'SR-GS-004';
      ...
      'TC-GS-006','Transport loading time', ...
        'Time from end-of-packaging to loaded-on-transport for 20 consecutive batches. Pass: all <= 10 min.', ...
        'SR-GS-006';
      'TC-GS-007','Contamination detection sensitivity', ...
        'Inject 100 spiked batches with known contaminant and 100 clean. Measure true-positive rate. Pass: >= 99%.', ...
        'SR-GS-007';
      ...
      'TC-GS-010','Inventory accuracy', ...
        'Physically count stored stock; compare against InventoryState. Pass: |actual - recorded| / recorded <= 1%.', ...
        'SR-GS-010';
      ...
      'TC-GS-016','Structural 12 g tolerance', ...
        'Subject structure to sustained 12 g loading on shake table or via FEA. Inspect for permanent deformation. Pass: FoS >= 1.5, no yield.', ...
        'SR-GS-016';
    };
